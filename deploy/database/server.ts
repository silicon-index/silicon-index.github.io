/**
 * Container bootstrap for the database module API (Coolify, Fly, any Docker host).
 *
 * This is the only runtime-specific file in the deployment. The handler it
 * serves — src/modules/database/api.ts — is pure WinterCG and is byte-identical
 ...
 */
import api from "../../src/modules/database/api";
