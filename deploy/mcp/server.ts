...
/**
 * Container bootstrap for the mcp module API (Coolify, Fly, any Docker host).
 *
 * This is the only runtime-specific file in the deployment. The handler it
 * serves — src/modules/mcp/api.ts — is WinterCG at the transport boundary
 * and is byte-identical to what Cloudflare Workers runs via wrangler.toml.
 *
 ...
 */
import api from "../../src/modules/mcp/api";
